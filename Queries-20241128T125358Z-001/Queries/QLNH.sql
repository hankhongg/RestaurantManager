...
DROP TABLE IF EXISTS STOCKIN_DETAILS_INGRE;
DROP TABLE IF EXISTS STOCKIN_DETAILS_DRINK_OTHER;
...
ALTER TABLE INGREDIENTS ADD INGRE_PRICE MONEY DEFAULT 0;


ALTER TABLE INGREDIENTS ADD INGRE_PRICE MONEY DEFAULT 0;

ALTER TABLE STOCKIN_DETAILS_DRINK_OTHER ADD TOTAL_CPRICE MONEY DEFAULT 0;
ALTER TABLE STOCKIN_DETAILS_INGRE ADD TOTAL_CPRICE MONEY DEFAULT 0;
ALTER TABLE MENU_ITEMS DROP COLUMN IS_AVAILABLE;
ALTER TABLE MENU_ITEMS ADD INSTOCK FLOAT DEFAULT 0;